...
void init_spi1_slow() {
    ...
    // Configure PB3 (SCK), PB4 (MISO), and PB5 (MOSI) as alternate function mode
    GPIOB->MODER &= ~(GPIO_MODER_MODER3_1 | GPIO_MODER_MODER3_0); 
    GPIOB->MODER |= GPIO_MODER_MODER3_1;

    GPIOB->MODER &= ~(GPIO_MODER_MODER4_1 | GPIO_MODER_MODER4_0); 
    GPIOB->MODER |= GPIO_MODER_MODER4_1; // Set bit 1 to 1

    GPIOB->MODER &= ~(GPIO_MODER_MODER5_1 | GPIO_MODER_MODER5_0); 
    GPIOB->MODER |= GPIO_MODER_MODER5_1; // Set bit 1 to 1
...
void sdcard_io_high_speed() {
    ...
    SPI1->CR1 &= ~SPI_CR1_BR;
    SPI1->CR1 |= SPI_CR1_BR_0; // Prescaler = 4
...
void init_lcd_spi() {
    ...
    GPIOB->MODER &= ~(GPIO_MODER_MODER8_1 | GPIO_MODER_MODER8_0); 
    GPIOB->MODER |= GPIO_MODER_MODER8_0;

    GPIOB->MODER &= ~(GPIO_MODER_MODER11_1 | GPIO_MODER_MODER11_0); 
    GPIOB->MODER |= GPIO_MODER_MODER11_0; 

    GPIOB->MODER &= ~(GPIO_MODER_MODER14_1 | GPIO_MODER_MODER14_0); 
